...
CREATE TABLE [dbo].[jobs] (
    ...
    [jobs_user_id]              INT            NULL,
    [jobs_title]                NVARCHAR (100) NULL,
    [jobs_posting_date]         DATETIME2 (7)  CONSTRAINT [DF_jobs_jobs_posting_date] DEFAULT (dateadd(hour,(8),getdate())) NULL,
    [jobs_application_deadline] DATETIME2 (7)  NULL,
    [jobs_description]          NVARCHAR (MAX) NULL,
    [jobs_status]               TINYINT        NULL,
    [jobs_required_skills]      NVARCHAR (500) NULL,
    [jobs_location]             NVARCHAR (100) NULL,
    [jobs_max_salary]           INT            NULL,
    [jobs_min_salary]           INT            NULL,
    [jobs_worktime]             NVARCHAR (50)  NULL,
    [jobs_number_of_openings]   INT            NULL,
    [major_category_id]         INT            NULL,
    PRIMARY KEY CLUSTERED ([jobs_id] ASC),
    FOREIGN KEY ([jobs_user_id]) REFERENCES [dbo].[users] ([user_id])
);
