...
('EV103', '數據科學訓練營', 1, 3, 103, GETDATE(), DATEADD(day, 5, GETDATE()), DATEADD(day, 7, GETDATE()), DATEADD(day, 6, GETDATE()), DATEADD(day, 7, GETDATE()), 800, '新竹', 100, '密集的數據科學訓練營', '立即報名！'),
('EV104', '網頁開發研討會', 1, 4, 104, GETDATE(), DATEADD(day, 10, GETDATE()), DATEADD(day, 11, GETDATE()), DATEADD(day, 10, GETDATE()), DATEADD(day, 11, GETDATE()), 400, '高雄', 200, '了解現代網頁開發', '座位有限');
