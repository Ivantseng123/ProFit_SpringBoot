...
('EV101', '金融高峰會', 1, 100, GETDATE(), DATEADD(day, 1, GETDATE()), DATEADD(day, 2, GETDATE()), DATEADD(day, 3, GETDATE()), 700, '高雄', 400, '領先的金融高峰會', '線上報名'),
('EV102', '人工智慧工作坊', 1, 100, GETDATE(), DATEADD(day, 3, GETDATE()), DATEADD(day, 1, GETDATE()), DATEADD(day, 2, GETDATE()), 300, '台北', 150, '人工智慧技術工作坊', '需要報名'),
('EV103', '數據科學訓練營', 1, 200, DATEADD(day, 5, GETDATE()), DATEADD(day, 7, GETDATE()), DATEADD(day, 6, GETDATE()), DATEADD(day, 7, GETDATE()), 800, '新竹', 100, '密集的數據科學訓練營', '立即報名！'),
('EV104', '網頁開發研討會', 1, 300, DATEADD(day, 10, GETDATE()), DATEADD(day, 11, GETDATE()), DATEADD(day, 10, GETDATE()), DATEADD(day, 11, GETDATE()), 400, '高雄', 200, '了解現代網頁開發', '座位有限');
